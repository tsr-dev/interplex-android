            ...
            success: function (data, status) {
                $.each(data, function (i, item) {
                    ...
                    if (item.Segment == "Press-Fit") {
                        ...
                        var subkategorie = replaceAll(item.Subcategory, "%20", " ");
                        $(".breadcrumb").append("<a href=startScreen.html>HOME</a> / <a href=Press-Fit.html>" + item.Segment + "</a> / <a href=P_" + kategorie + ".html>" + item.Category + "</a> / <a href='Products_Entertainment_system(update).html?category=" + item.Subcategory + "&main_category=" + item.Category + "'>" + item.Subcategory + "</a>");
                    }
