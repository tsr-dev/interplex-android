         ...
         success: function(data, status){
                    ...
                    // $("#form_list").append("<option value='"+item.Name+"'>"+item.Name+"</option>");
                      ...
                      $(".breadcrumb").html("<a href=startScreen.html>HOME</a> / <a href=datacom.html>"+item.Segment+"</a> / <a href=D_"+kategorie+".html>"+item.Category+"</a> / <a href='Products_Entertainment_system.html?category="+item.Subcategory+"&main_category="+item.Category+"'>"+item.Subcategory+"</a>" );
                        ...
                        var subkategorie =  replaceAll(item.Subcategory,"%20"," ");
                        var kategorie =  replaceAll(item.Category," ","_");
                        $(".tabs_sub_" + columnSide).append("<div class='category_name_product'><a href='products_level.html?name="+item.Name+"&main_category="+kategorie+"&subcategory="+subkategorie+"'><img width='100%' src=https://noel777.com/Auto/thumbs/"+item.Mark+".jpg /></a><div class='name_cat'>"+item.Name+"</div></div>");
...
function ajax(subcategory_name, main_category, name){
   ...
   // var c=1;
    ...
    try {
    $.ajax({
        url: 'https://noel777.com/Auto/feetch_products_page.php',
        type: "GET",
        dataType: 'jsonp',
        jsonp: 'callback',
        data:{
