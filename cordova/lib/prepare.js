...
function updateProjectAccordingTo (platformConfig, locations) {
    ...
    var name = platformConfig.android_name() || platformConfig.name();
    strings.find('string[@name="app_name"]').text = name.replace(/\'/g, '\\\'');

    var shortName = platformConfig.android_shortName && platformConfig.android_shortName() || platformConfig.shortName && platformConfig.shortName();
    ...
    manifest.setVersionName(platformConfig.getPreference('android-versionName', 'android') || platformConfig.version())
