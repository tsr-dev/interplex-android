...
ConfigParser.prototype = {
    ...
    android_name: function () {
        return getNodeTextSafe(this.doc.find('android-name'));
    },
    ios_name: function () {
        return getNodeTextSafe(this.doc.find('ios-name'));
    },
    setName: function (name) {
        var el = findOrCreate(this.doc, 'name');
        el.text = name;
    },
    setAndroidName: function (name) {
        var el = findOrCreate(this.doc, 'android-name');
        el.text = name;
    },
    setIosName: function (name) {
        var el = findOrCreate(this.doc, 'ios-name');
        el.text = name;
    },
    shortName: function () {
        return this.doc.find('name').attrib['short'] || this.name();
    },
    android_shortName: function () {
        return this.doc.find('android-name').attrib['short'] || this.android_name();
    },
    ios_shortName: function () {
        return this.doc.find('ios-name').attrib['short'] || this.ios_name();
    },
